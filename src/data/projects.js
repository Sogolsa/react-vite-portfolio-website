const projects = [
  {
    ...
    description: `A web application designed to help Graduate Assistants easily set their
  ...
  },
  {
    ...
    description: `Designed and developed a minimalist personal brand landing page for an
  ...
  },
  {
    ...
    description: `A React-vite app that let's the users to enter information needed to
...

  {
    ...
    description: `The client side of Thought Tracker Journal API using React-vite and
  ...
  },
  {
    ...
    description: `This Beginner's Guide to Developing a RESTful API is a step by step
  ...
  },
  {
    ...
    description: `An API to help organizing thoughts to help with anxiety, in this API,
  ...
  },
  {
    ...
    description: `This is a react app where I have fetched the exercises data from rapid
  ...
  {
    title: "Recipe App",
    description: `A recipe app using Django web framework. In this application PostgreSQL
